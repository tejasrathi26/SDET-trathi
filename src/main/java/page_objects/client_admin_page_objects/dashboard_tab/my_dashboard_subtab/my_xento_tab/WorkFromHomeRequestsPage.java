...
public class WorkFromHomeRequestsPage extends BasePage{
    public WorkFromHomeRequestsPage(WebDriver driver){
        super(driver);
    }
    private final By ADD_REQUEST = By.cssSelector("#view_work_from_home_requests > a");
