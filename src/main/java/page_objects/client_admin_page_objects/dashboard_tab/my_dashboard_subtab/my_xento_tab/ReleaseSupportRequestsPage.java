...
public class ReleaseSupportRequestsPage extends BasePage {
    public ReleaseSupportRequestsPage(WebDriver driver){
        super(driver);
    }
    private final By ADD_REQUEST = By.xpath("//*[@id=\"view_release_support_requests\"]/div[2]/div/a");
